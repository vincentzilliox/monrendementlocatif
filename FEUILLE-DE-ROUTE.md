...
### 2.3 Les sources — huit branchées, deux écartées
...
| [REI de la DGFiP](https://data.economie.gouv.fr/explore/dataset/impots-locaux-fichier-de-recensement-des-elements-dimposition-a-la-fiscalite-dir/) 2022 et 2025 | Taux de taxe foncière bâtie (commune, syndicats, intercommunalité) et revalorisation légale des bases | Hausse annuelle de la taxe d'un même logement, face à l'inflation des charges retenue | ✅ *Fait le 2026-09-23.* Le REI 2022 n'existe qu'en classeur Excel de 140 Mo, lu en flux. Le montant de la taxe reste inconnu : il dépend de la valeur locative du logement. |
| Taux des droits de mutation par département | Taux départemental | Frais de notaire au lieu de 8 % partout | Non fait : aucune source ouverte ne publie les taux (seulement les montants perçus). Gain faible, 7,5 % ou 8 % ; à relever à la main si un jour utile. |
...
| INSEE (recensement) et LOVAC (Cerema) | Taux de logements vacants | Vacance par défaut | Écarté : la vacance du recensement mêle logements hors marché et vétustes ; elle ne mesure pas la vacance locative d'un bien loué, et la proposer comme défaut tromperait. |
| [DPE logements existants](https://data.ademe.fr/datasets/dpe03existant) (ADEME) | Part des DPE depuis 2021 classés F ou G, par commune (au moins 30), sinon par département | Contexte du champ DPE, dans le résumé « face au marché » | ✅ *Fait le 2026-09-23*, par l'API d'agrégation : deux requêtes par département, mises en cache. |
